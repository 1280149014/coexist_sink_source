...
import android.bluetooth.IBluetoothSocketManager_second;
...
/**
 * System private API for talking with the Bluetooth second service.
 *
 * {@hide}
 */
interface IBluetooth_second
{
    int getState();
    ...
    // For Socket
    IBluetoothSocketManager_second getSocketManager();
